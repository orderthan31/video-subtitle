...
export type VerificationBlock = {uploaded_bytes: number; offset: number; length: number; sha256: string};

export async function verifyUploadedPrefix(
  file: Blob, uploaded: number, signal: AbortSignal,
